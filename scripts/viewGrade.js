$(document).ready(function () {
    ...
    $("div.DialogFakFak").click(function () {
        ...
        if (obj_this_contentGrade.is(':hidden')) {
            ...
            if ($(".content_grade").is(':visible')) {
                ...
                $(".COCOpen").not($(this).find(".COCOpen")).toggleClass("COCOpen COC");
                $(".COOpen").addClass(".CO");
            ...
            $(this).find(".COC").toggleClass("COC COCOpen");
                        ...
                        $(function () {
                            obj_this_contentGrade.find('div.Otmetka').each(function () {
                                ...
                                if (block == 1) {
                                    ...
                                    ($(this).attr('data-Status')==2) ? $(this).parent(".Oc").append("<div class='coin'><img src='scripts/images/coin.png'></div>") : "";
    ...
    $('div').delegate(".fullTextClose", "click", function (event) {
        ...
        $(this).parent().find(".COCOpen").toggleClass("COCOpen COC");
...
$(function () {
    ...
    $('div').delegate(".replaceAbs", "click", function (e) {
...
function Available(grade) {
    ...
    for (var i = 0; i < c_gr.length; i++) {
        if (((absenteeisms.indexOf(c_gr[i]) != -1) || (absenteeisms_with_cause.indexOf(c_gr[i]) != -1)) && ((curStatus==0) || (curStatus==5))) {
            return 1;
        } 
    }
}
