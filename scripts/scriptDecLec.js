...
$(function () {
        $("div.statistic").append("<div class='date_col_stat_small'><div class='title_small'>Н(ув)</div><div class='absenteesm_small'></div></div>");
...
$(function() {
    var form, edit_dialog, edit_form, confirm_make_pay, confirm_make_form;
